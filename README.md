...
Individual commands are broken down below
...
| `npm run sass:watch`      | Watch your Sass files for changes                |
| `npm run sass:build`      | Build your CSS files from Sass                   |
